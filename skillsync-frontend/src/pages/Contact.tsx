            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:faizanrock@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                      faizanrock@gmail.com
                    </a>
                  </div>
                </div>
              ...
              <div className="pt-8 border-t border-border">
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    href="https://www.linkedin.com/in/faizan-rock-a90744238/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3 bg-secondary rounded-lg hover:bg-primary/10 transition-colors group"
                  >
